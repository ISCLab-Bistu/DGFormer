...
class DGFormer_DGA_EFFN(Dual_Granularity_Former):
    def __init__(self, **kwargs):
        super(DGFormer_DGA_EFFN, self).__init__(
            patch_size=4, embed_dims=[32, 64, 160, 256], num_heads=[2, 4, 10, 16], mlp_ratios=[4, 4, 4, 4],
