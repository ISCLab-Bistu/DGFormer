...
def get_args_parser():
    parser = argparse.ArgumentParser('DGFormer training and evaluation script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='dgformer', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default=r'/home/ubuntu/Downloads/data/imagenet/ILSVRC2012/imagenet', type=str,
                        help='dataset path')
